...
public class AprilTagsWrapper {
    ...
    private int gear_ratio = 40;
    private double diameter = 4.125;
    //  int initialLinears;
    private double cpi = (cpr * gear_ratio) / (Math.PI * diameter); //counts per inch, 28cpr * gear ratio / (2 * pi * diameter (in inches, in the center))
    ...
    private double tagsize = 0.04;  // was .166
    ...
    public AprilTagsWrapper(HardwareMap hwmp, Telemetry tmtry) {
        hardwareMap = hwmp;
        telemetry = tmtry;
    }
