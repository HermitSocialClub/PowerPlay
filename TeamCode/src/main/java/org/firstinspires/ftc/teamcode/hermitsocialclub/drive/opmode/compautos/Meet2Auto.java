...
// put the stuff that does the stuff before parking here
        ...
        Trajectory myTrajectory = drive.trajectoryBuilder(toFirstCone)
                .splineTo(new Vector2d(-19, 9), Math.toRadians(240))
...
//                .forward(15)
        ...
        Trajectory t2 = drive.trajectoryBuilder(new Pose2d(-20, 5.5, Math.toRadians(180)))
                        .forward(21.5)
                                .build();

        Trajectory t3 = drive.trajectoryBuilder(new Pose2d(-19, 9, Math.toRadians(230)))
        ...
        Trajectory tback = drive.trajectoryBuilder(t2.end()).forward(17).build();

        Trajectory tbackstrafe = drive.trajectoryBuilder(tback.end()).strafeRight(15).build();

        Trajectory tbacktwo = drive.trajectoryBuilder(tback.end()).forward(10).build();
