...
@Autonomous(name="Auto: Sleeve Detector")
public class SleeveDetecterOpMode extends LinearOpMode {
    // Handle hardware stuff...

    int width = 320;
    int height = 240;
    // store as variable here so we can access the location
    SleeveDetector detector = new SleeveDetector(width);
    ...
    public void runOpMode() {
        ...
        SleeveDetector.ParkingLocation location = detector.getLocation();
        if (location != SleeveDetector.ParkingLocation.CENTER) {
